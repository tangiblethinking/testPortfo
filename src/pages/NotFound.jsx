...
export default function NotFound() {
  return (
    <main style={{ background: 'var(--ink-primary)', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 'clamp(1.5rem,5vw,3rem)', textAlign: 'center' }}>
